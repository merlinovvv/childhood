...
<div class="reply">
    <div class="reply__body">
        ...
        <div>
            <?php echo do_shortcode('[contact-form-7 id="89f990e" title="Форма вопросов"]'); ?>
        </div>
    </div>
</div>
...
?>
<script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAcJOeWilmkHY2CU79oaEoNGr1LUAN8dxc&callback=Function.prototype">
</script>
